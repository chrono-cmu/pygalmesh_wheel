...
# scp -r -i $HOME/Documents/wheel_sim_pipeline/key_pair_psc "$USERNAME@$CLUSTER_HOST:$PROJECT_PATH/" "$LOCAL_DOWNLOAD_PATH"
echo "Downloaded File"
echo "$PROJECT_PATH/automation_test_$job_id_arg"
}
