...
def GenWheel(rad=0.25, width=0.2, cp_deviation=0., g_height=0.02, g_width=0.005, g_density=12, g_amp=0., g_period=1, g_curved=False, filename="wheel.obj", tri_count=25000, shell_thickness=0.002):
